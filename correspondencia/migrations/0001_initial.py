    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario_destino', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='usuario_destino', to=settings.AUTH_USER_MODEL)),
                ('usuario_rtte', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='usuario', to=settings.AUTH_USER_MODEL)),
            ],
            options={
